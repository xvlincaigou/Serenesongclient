...
export default {
  data() {
    return {
      ...
      friends: [
        { name: '好友1', avatar: '/static/dialog/avatar1.png' },
        { name: '好友2', avatar: '/static/dialog/avatar2.png' },
        { name: '好友3', avatar: '/static/dialog/avatar3.png'},
        { name: '好友4', avatar: '/static/dialog/avatar4.png' },
        { name: '好友5', avatar: '/static/dialog/avatar5.png'},
        { name: '好友6', avatar: '/static/dialog/avatar6.png' },
      ],
      allPosts: [
        {
          title: "钗头凤--陆游",
          content: "酥手为何而红？",
          date: "2023-12-18",
          avatar: '/static/dialog/avatar1.png',
          nickname: '用户1',
          category: '词评',
          liked: false,
        ...
        },
        {
          ...
          content: "好雨知时节，当春乃发生。\n随风潜入夜，润物细无声。\n野径云俱黑，江船火独明。\n晓看红湿处，花重锦官城。",
          date: "2024-4-5",
          avatar: '/static/dialog/avatar2.png',
          nickname: '用户2',
          category: '作品',
          liked: false,
          detail: "",
        },
        {
          ...
          date: "2024-6-9",
          avatar: '/static/dialog/avatar3.png',
          nickname: '用户3',
          category: '作品',
          liked: false,
          detail: "",
        },
        {
          ...
          date: "2024-10-18",
          avatar: '/static/dialog/avatar4.png',
          nickname: '用户4',
          category: '观点',
          liked: false,
          detail: "",
        },
        {
          ...
          content: "",
          date: "2024-11-5",
          avatar: '/static/dialog/avatar5.png',
          nickname: '用户5',
          category: '推荐',
          liked: false,
      ...
      friendPost: [
        ...
        },
        {
          ...
          date: "2024-11-07",
          avatar: '/static/dialog/avatar6.png',
          nickname: '好友B',
          category: '作品',
          liked: false,
          detail: "",
  ...
  methods: {
    ...
    viewPost(post) {
      uni.navigateTo({
        url: `/pages/community/postDetail/postDetail?title=${encodeURIComponent(post.title)}&date=${post.date}&content=${encodeURIComponent(post.content)}&avatar=${encodeURIComponent(post.avatar)}&nickname=${encodeURIComponent(post.nickname)}&category=${encodeURIComponent(post.category)}&detail=${encodeURIComponent(post.detail)}`
      });
    },
    share(item) {
      uni.showToast({
    ...
    comment(item) {
      uni.navigateTo({
        url: `/pages/community/postDetail/postDetail?title=${encodeURIComponent(item.title)}&date=${item.date}&content=${encodeURIComponent(item.content)}&avatar=${encodeURIComponent(item.avatar)}&nickname=${encodeURIComponent(item.nickname)}&category=${encodeURIComponent(item.category)}&detail=${encodeURIComponent(item.detail)}`
      });
    },
    love(item) {
    ...
    viewFriend(friend) {
      uni.navigateTo({
        url: `/pages/community/friendProfile/friendProfile?name=${encodeURIComponent(friend.name)}&avatar=${encodeURIComponent(friend.avatar)}`
      });
    },
	createPost() {
	  uni.navigateTo({
