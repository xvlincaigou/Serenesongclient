	...
	refreshRecommendations() {
     ...
     navigateToDetail(name) {
	  this.fetchCipaiDetails(name).then(cipai => {
		...
		uni.navigateTo({
		  url: `/pages/info/info_cipai/info_cipai?cipai=${encodeURIComponent(JSON.stringify(cipaiDetail))}`
		});
	  }).catch(error => {
